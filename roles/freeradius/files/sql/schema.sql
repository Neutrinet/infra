...
-- CREATE UNIQUE INDEX IF NOT EXISTS radacct_whoson on radacct (AcctStartTime, nasipaddress);
...
-- CREATE INDEX IF NOT EXISTS radacct_session_idx ON radacct (AcctUniqueId);

-- For backwards compatibility
-- CREATE INDEX IF NOT EXISTS radacct_active_user_idx ON radacct (AcctSessionId, UserName, NASIPAddress) WHERE AcctStopTime IS NULL;
...
-- and, optionally
CREATE INDEX IF NOT EXISTS radacct_stop_user_idx ON radacct (acctStopTime, UserName);
 ...
 */
-- CREATE INDEX IF NOT EXISTS radcheck_UserName_lower on radcheck (lower(UserName),Attribute);
 ...
 * Use this index if you use case insensitive queries
 */
-- CREATE INDEX IF NOT EXISTS radreply_UserName_lower on radreply (lower(UserName),Attribute);
 ...
 * Use this index if you use case insensitive queries
 */
-- CREATE INDEX IF NOT EXISTS radusergroup_UserName_lower on radusergroup (lower(UserName));
